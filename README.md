...
当前版本 **0.5.4**：文章列表显示筛选总数、本页数量及跨页连续序号，末页自动禁用下一页；保留独立来源检查、紧凑阅读布局和双语 AI 队列。详见 [阅读使用说明](docs/READING.md)、[提示词与缓存](docs/READING-AI.md) 和 [验证记录](docs/validation-v054.md)。
...
# 运行
./artifacts/QuietDesk-v0.5.4-win-x64/QuietDesk.exe
